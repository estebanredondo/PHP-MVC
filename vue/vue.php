			...
			return '<div id="menucss">
					<ul>
						...
						<li><span class="titremenucss">Les articles</span>
							<ul>
								<li><a href="index.php?controleur=article&action=rechArticles&id=">Visualiser</a></li>
							</ul>
						</li>
						<li><span class="titremenucss">Les clients</span>
							<ul>
								<li><a href="index.php?controleur=client&action=rechClients&id=">Rechercher</a></li>
								<li><a href="index.php?controleur=client&action=creaClient&id=">Créer</a></li>
							</ul>
						</li>
					</ul>	
				...
				<div id="menucss2">
					<img src="images/cadenas_o16.png" width="16" height="16"><a href="index.php?controleur=authentification&action=deconnexion&id=">Déconnexion</a>
			  </div>';
		}
		else	
		{
			...
			return '<div id="menucss">
				...
				<div id="menucss2">
					<img src="images/cadenas_f16.png" width="16" height="16"><a href="index.php?controleur=authentification&action=authentification&id=">Connexion</a>
